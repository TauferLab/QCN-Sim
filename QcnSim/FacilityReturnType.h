...
enum class FacilityReturnType {
	...
	FACILITY_BUSY_TOKEN_ENQUEUED,			//!< Facility was busy; token was enqueued.
	FACILITY_DOWN_TOKEN_DROPPED,			//!< Facility is down.  Token was dropped (or enqueued, depending on the implementation of function Facility::request).
	...
	FACILITY_BUSY_QUEUE_FULL_TOKEN_DROPPED, //!< The queue is full (has reached the imposed limit); token for which service was requested was dropped.
