 ...
 * if the left eventTime happens earlier than the right eventTime.
 * 
 ...
 * @details 
 * This is the overloading of the > operator.  The result should be TRUE
 * if the left eventTime happens later than the right eventTime.
 * 
 * @param left The EventChainElement object to the "left", to be compared with the "right".
 * @param right The EventChainElement object to the "right", to be compared with the "left".
 */
 ...
 * @details 
 * This is the overloading of the <= operator.  The result should be TRUE
 * if the left eventTime happens earlier or at the same time as the right eventTime.
 * 
 * @param left The EventChainElement object to the "left", to be compared with the "right".
 * @param right The EventChainElement object to the "right", to be compared with the "left".
 */
 ...
 * @details 
 * This is the overloading of the >= operator.  The result should be TRUE
 * if the left eventTime happens later or at the same time as the right eventTime.
 * 
 * @param left The EventChainElement object to the "left", to be compared with the "right".
 * @param right The EventChainElement object to the "right", to be compared with the "left".
 */
 ...
 *
 * @details 
 * This is the overloading of the comparison == operator for use with EventChainElement.  The result should be FALSE
 * if the left EventChainElement has the same contents as the right EventChainElement.
 * 
 * @param left The EventChainElement object to the "left", to be compared with the "right".
 * @param right The EventChainElement object to the "right", to be compared with the "left".
