...
public:
	...
	/// @note Dequeued tokens will be placed at front of event chain, with corresponding event, such that service time can be calculated real time... this is why we need EventType here.
