...
TEST_F(NodeTest, TokenStatistics) {
	...
	std::shared_ptr<Token> token1(new Token(simulatorGlobals, 1, nullptr, nodeVector.at(0), nodeVector.at(2)));
	// Attach route vector (NOT route object) to token's Route object and set it to record route.
	...
	std::shared_ptr<Token> token2(new Token(simulatorGlobals, 2, nullptr, nodeVector.at(0), nodeVector.at(2)));
	// Attach route vector (NOT route object) to token's Route object and set it to record route.
	...
	std::shared_ptr<Token> token3(new Token(simulatorGlobals, 3, nullptr, nodeVector.at(0), nodeVector.at(2)));
	// Attach route vector (NOT route object) to token's Route object and set it to record route.
...
TEST_F(NodeTest, PDUStatistics) {
	...
	std::shared_ptr<ProtocolDataUnit> pdu1(new ProtocolDataUnit(simulatorGlobals, 1, nullptr, nodeVector.at(0), nodeVector.at(2), 1000));
	// Get initial ttl
	...
	simulatorGlobals.setCurrentAbsoluteTime(30.0);
	std::shared_ptr<ProtocolDataUnit> pdu2(new ProtocolDataUnit(simulatorGlobals, 2, nullptr, nodeVector.at(0), nodeVector.at(2), 1000));
	// Get initial TTL.
	ttl = pdu2->getTtl();
	// Attach route vector (NOT route object) to pdu's Route object and set it to record route.
	...
	simulatorGlobals.setCurrentAbsoluteTime(55.0);
	std::shared_ptr<ProtocolDataUnit> pdu3(new ProtocolDataUnit(simulatorGlobals, 3, nullptr, nodeVector.at(0), nodeVector.at(2), 1000));
	// Get initial TTL.
	ttl = pdu3->getTtl();
	// Attach route vector (NOT route object) to pdu's Route object and set it to record route.
