...
TEST_F(FacilityTest, ConstructorOne) {
	...
	// Change name.
	facility1.setName("Facility One renamed.");
	EXPECT_EQ("Facility One renamed.", facility1.getName());
	...
	EXPECT_EQ(0, facility1.getMaxRecordedQueueSize());
...
TEST_F(FacilityTest, ConstructorMany) {
	...
	EXPECT_EQ(0, facility4.getMaxRecordedQueueSize());
...
TEST_F(FacilityTest, PurgeQueue) {
	...
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility1.request(token1, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility1.request(token2, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility1.request(token3, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility1.request(token4, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility1.request(token5, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility1.request(token6, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility1.request(token7, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility1.request(token8, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility1.request(token9, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(9, facility1.getQueueSize());
	EXPECT_EQ(9, facility1.getMaxRecordedQueueSize());
	// Purge queue by making the facility down.
	// First advance clock.
	simulatorGlobals.setCurrentAbsoluteTime(10.0);
	EXPECT_EQ(10, facility1.setDown());
	EXPECT_EQ(0, facility1.getDequeuedTokensCount()); // Tokens were dropped, not dequeued.
	EXPECT_EQ(10, facility1.getDroppedTokensCount());

	// Request service while facility is down.
	EXPECT_EQ(FacilityReturnType::FACILITY_DOWN_TOKEN_DROPPED, facility1.request(tokenService, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(11, facility1.getDroppedTokensCount());
	EXPECT_EQ(FacilityReturnType::FACILITY_DOWN_TOKEN_DROPPED, facility1.request(token1, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(12, facility1.getDroppedTokensCount());
	// Bring facility up, request service.
	facility1.setUp();
	EXPECT_TRUE(facility1.isUp());
	EXPECT_EQ(FacilityReturnType::TOKEN_PUT_IN_SERVICE, facility1.request(tokenService, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(12, facility1.getDroppedTokensCount());
	...
	// Do the same for a 3-server facility.
	Facility facility2 = Facility("Facility Two", 3, simulatorGlobals, scheduler);

	EXPECT_EQ(FacilityReturnType::TOKEN_PUT_IN_SERVICE, facility2.request(tokenService, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::TOKEN_PUT_IN_SERVICE, facility2.request(token1, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::TOKEN_PUT_IN_SERVICE, facility2.request(token2, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility2.request(token3, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility2.request(token4, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility2.request(token5, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility2.request(token6, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility2.request(token7, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility2.request(token8, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility2.request(token9, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	// First advance clock, set facility down, request service while down.
	simulatorGlobals.setCurrentAbsoluteTime(20.0);
	EXPECT_EQ(10, facility2.setDown());
	EXPECT_EQ(10, facility2.getDroppedTokensCount());
	EXPECT_EQ(FacilityReturnType::FACILITY_DOWN_TOKEN_DROPPED, facility2.request(tokenService, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(11, facility2.getDroppedTokensCount());
	EXPECT_EQ(FacilityReturnType::FACILITY_DOWN_TOKEN_DROPPED, facility2.request(token1, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(12, facility2.getDroppedTokensCount());
	// Bring facility up, request service.
	facility2.setUp();
	EXPECT_TRUE(facility2.isUp());
	EXPECT_EQ(FacilityReturnType::TOKEN_PUT_IN_SERVICE, facility2.request(tokenService, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(12, facility2.getDroppedTokensCount());
	EXPECT_FALSE(facility2.isBusy()); // Not busy, it is a 3-server facility.
}
...
TEST_F(FacilityTest, RequestReleaseQueue) {
	...
	EXPECT_EQ(0, facility1.getQueueSize());
	EXPECT_EQ(0, facility1.getDroppedTokensCount());
	EXPECT_EQ(2, facility1.getMaxRecordedQueueSize());
...
TEST_F(FacilityTest, RequestMultipleServers) {
	...
	EXPECT_EQ(7, facility1.getMaxRecordedQueueSize());
...
/// Tests a facility with limited queue size for dropped tokens.
TEST_F(FacilityTest, LimitedQueueSizeFacility) {
	// Build a facility with 3 servers.
	Facility facility1 = Facility("Facility One", 3, simulatorGlobals, scheduler);
	// Build some tokens.
	std::shared_ptr<Message> dummyEntitySource(new Message("This is a dummy entity for source."));
	...
	EXPECT_FALSE(facility1.isBusy());
	EXPECT_TRUE(facility1.isUp());
	// Get queue size limit; must be default.
	EXPECT_EQ(std::numeric_limits<unsigned int>::max(), facility1.getQueueSizeLimit());
	// Set a queue size limit to force dropped tokens.
	facility1.setQueueSizeLimit(3);

	// Request service for 5 tokens; first will go into service, 4 will go into queue.
	EXPECT_EQ(FacilityReturnType::TOKEN_PUT_IN_SERVICE, facility1.request(tokenService, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::TOKEN_PUT_IN_SERVICE, facility1.request(token1, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(FacilityReturnType::TOKEN_PUT_IN_SERVICE, facility1.request(token2, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_TRUE(facility1.isBusy());
	...
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility1.request(token5, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	// Test queue size.
	EXPECT_EQ(3, facility1.getQueueSize());
	// Now request service for more tokens, check whether they are being discarded.	
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_QUEUE_FULL_TOKEN_DROPPED, facility1.request(token6, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(1, facility1.getDroppedTokensCount());
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_QUEUE_FULL_TOKEN_DROPPED, facility1.request(token7, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(2, facility1.getDroppedTokensCount());
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_QUEUE_FULL_TOKEN_DROPPED, facility1.request(token8, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(3, facility1.getDroppedTokensCount());
	// Release token from service, request service for a new one; must go into queue now.
	EXPECT_EQ(FacilityReturnType::TOKEN_RELEASED_DEQUEUED_SERVICE_EVENT_SCHEDULED, facility1.release(tokenService));
	// Schedule request for the just released token.
	Event event = scheduler.cause();
	EXPECT_EQ(FacilityReturnType::TOKEN_PUT_IN_SERVICE, facility1.request(std::dynamic_pointer_cast<const Token>(event.entity), EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(2, facility1.getQueueSize());
	EXPECT_EQ(FacilityReturnType::FACILITY_BUSY_TOKEN_ENQUEUED, facility1.request(token9, EventType::REQUEST_SERVICE_FOR_TOKEN_AT_FACILITY));
	EXPECT_EQ(3, facility1.getDroppedTokensCount());
	//EXPECT_EQ(3, facility1.getQueueSize());
